    ...
    <div class="container">
        ...
        <div class="createpost">
            <form method="post" action="" onsubmit="return validatePost()" enctype="multipart/form-data">
                <h2 class="mt-2 ms-3">Create Post</h2>
                <hr>
                <span class="required" style="display:none;">Please Write Something!.</span><br>
                <textarea rows="6" name="caption" placeholder="Post Something!" class="mx-2" style="border:none; outline:none"></textarea>
